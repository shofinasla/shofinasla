...
Saya ingin konsultasi lebih lanjut mengenai kebutuhan website bisnis saya.`;
  ...
  return (
    <section id="calculator" className="py-20 bg-slate-900/40 relative border-b border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
                ...
                {webTypes.map((type) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="mt-2 text-xs font-mono text-emerald-400 block font-semibold">
                ...
                {addOns.map((addon) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-xs font-mono text-emerald-400 font-semibold shrink-0 ml-3">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-28 bg-slate-950 border border-indigo-500/30 rounded-2xl p-6 sm:p-7 space-y-6 shadow-2xl">
              ...
              <a
                ...
                className="w-full py-3.5 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/25 active:scale-95"
              >
              ...
              <div className="flex items-start gap-2 text-[10px] text-slate-400 leading-relaxed bg-slate-900/30 p-2.5 rounded-lg border border-slate-800">
